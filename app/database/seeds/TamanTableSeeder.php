...
//foto, alamat, nama || public_path().'\\assets\\images\\taman_01.jpg'
			...
			['nama' => "Taman Fotografi", 'alamat' => "-", 'foto' => url('MyPark/public/assets/images/taman_04.jpg', $parameters = array(), $secure = null), 'deskripsi' => "Taman ini sengaja dibuat sebagai sebuah ruang publik bagi mereka pecinta fotografi. Di taman inilah sering kali diadakan berbagai kegiatan yang berhubungan dengan dunia fotografi. Dibangunnya Taman Fotografi ini sendiri sangat disambut baik oleh komunitas."
			],
