...
//foto, alamat, nama || public_path().'\\assets\\images\\taman_01.jpg'
			...
			['nama' => "Taman Lalu Lintas", 'alamat' => "Jalan Kalimantan", 'foto' => url('MyPark/public/assets/images/taman_13.jpg', $parameters = array(), $secure = null), 'deskripsi' => "Taman Lalu-lintas Ade Irma Suryani yaitu taman rekreasi yang ada di jantung kota Bandung. Selain sebagai taman, disini juga dijadikan pusat latihan membaca rambu-rambu lalu lintas. Taman Lalu Lintas adalah tempat yang tepat bagi anak untuk belajar kelalulintasan."],
			['nama' => "Taman Arcamanik", 'alamat' => " Jalan Arcamanik Endah", 'foto' => url('MyPark/public/assets/images/taman_14.jpg', $parameters = array(), $secure = null), 'deskripsi' => "Taman Arcamanik ini adalah taman yang baru dikembalikan fungsionalitas nya sejak agustus 2014. Taman ini sebelumnya ditempati PKL untuk berjualan."],
			['nama' => "Taman Tongkeng/Anak", 'alamat' => "Jalan. Tongkeng (Jalan. Patrakomala)", 'foto' => url('MyPark/public/assets/images/taman_15.jpg', $parameters = array(), $secure = null), 'deskripsi' => "Taman Tongkeng adalah taman yang dibuat dengan tujuan untuk menumbuhkan minat baca warga sebesar 0,01% demi persiapan mewujudkan World Book Capital 2017. Di taman ini tersedia perpustakaan sehingga diharapkan warga tidak buta huruf"],
			['nama' => "Taman Dewi Sartika/Sejarah", 'alamat' => "Jalan Merdeka", 'foto' => url('MyPark/public/assets/images/taman_16.jpg', $parameters = array(), $secure = null), 'deskripsi' => "Taman Dewi Sartika adalah bagian dari Taman Balai Kota Bandung yang memiliki sejarah panjang di Bandung, sebagai salah satu taman di Bandung, taman ini merupakan taman tertua di Kota Bandung. Taman ini sengaja dibangun untuk mengenang jasa pahlawan nasional Indonesia yang berasal dari kota ini. "]
